...
switch (side (_this select 0)) do 
{
	case west:
	{
		...
		_rifle = ["JCA_arifle_M4A4_AFG_black_F"];
		_rifleGL = ["JCA_arifle_M4A4_GL_black_F"];
		_rifle_Mags	= "JCA_30Rnd_556x45_Tracer_IR_PMAG";
		_rifle_Mags_Tr = "JCA_30Rnd_556x45_Tracer_IR_PMAG";
		...
		_rifleAttBipod = [""];
		_rifleAttScope = ["JCA_optic_AICO_black"];
		...
		_rifleMark = ["JCA_arifle_SR10_AFG_black_F"];
		_rifleMark_Mags = "JCA_20Rnd_762x51_black_PMAG";
